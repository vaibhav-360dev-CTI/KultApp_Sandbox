({
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (startPosition < endPosition) {
                    ...
                    this.showToast('Follow Up Request Sent Successfully', 'Success', 'success');
    ...
    sendFollowUp: function (component, event, helper){
        debugger;
        ...
        action.setCallback(this, function (response) {
                ...
                if (state === 'SUCCESS') {
                    ...
                    this.showToast('Some Error Occured!', 'Error', 'error');
                }
            });
            $A.enqueueAction(action);
    }
