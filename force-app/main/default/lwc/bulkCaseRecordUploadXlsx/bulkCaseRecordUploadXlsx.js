                    ...
                    for (var i = 0; i < data.length; i++) {
                         ...
                         if(!orderNumbers.includes(data[i]["Order No"]) && !orderNumbers.includes(data[i]["Order Id"])){
                              var obj = {
                                   ...
                                   "sku3cancelledquantity": data[i]["SKU 3 Cancelled Quantity"],
                                   "sku3id": data[i]["SKU 3 ID"],
                                   "sku3orderquantity": data[i]["SKU 3 Order Quantity"],
                                   "sku4cancelledquantity": data[i]["SKU 4 Cancelled Quantity"],
                                   "sku4id": data[i]["SKU 4 ID"],
                                   "sku4orderquantity": data[i]["SKU 4 Order Quantity"],
                                   "sku5cancelledquantity": data[i]["SKU 5 Cancelled Quantity"],
                                   "sku5id": data[i]["SKU 5 ID"],
                                   "sku5orderquantity": data[i]["SKU 5 Order Quantity"],
                                   "sku6cancelledquantity": data[i]["SKU 6 Cancelled Quantity"],
                                   "sku6id": data[i]["SKU 6 ID"],
                                   "sku6orderquantity": data[i]["SKU 6 Order Quantity"],
                                   "sku7cancelledquantity": data[i]["SKU 7 Cancelled Quantity"],
                                   "sku7id": data[i]["SKU 7 ID"],
                                   "sku7orderquantity": data[i]["SKU 7 Order Quantity"],
                                   "sku8cancelledquantity": data[i]["SKU 8 Cancelled Quantity"],
                                   "sku8id": data[i]["SKU 8 ID"],
                                   "sku8orderquantity": data[i]["SKU 8 Order Quantity"],
                                   "sku9cancelledquantity": data[i]["SKU 9 Cancelled Quantity"],
                                   "sku9id": data[i]["SKU 9 ID"],
                                   "sku9orderquantity": data[i]["SKU 9 Order Quantity"],
                                   "sku10cancelledquantity": data[i]["SKU 10 Cancelled Quantity"],
                                   "sku10id": data[i]["SKU 10 ID"],
                                   "sku10orderquantity": data[i]["SKU 10 Order Quantity"],
                                   "sno": index,
