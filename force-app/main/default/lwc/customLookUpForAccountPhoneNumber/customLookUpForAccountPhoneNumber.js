...
import getLookupValues from '@salesforce/apex/customLookupForAccount.getLookupValues';
import getinitRecord from '@salesforce/apex/customLookupForAccount.getinitRecord';
import gerRecentlyCreatedRecords from '@salesforce/apex/customLookupForAccount.gerRecentlyCreatedRecords';
export default class CustomLookUpForAccountPhoneNumber extends LightningElement {
//public properties
@api uniqueName = 'Account';
@api initialLookupValue = '';
@api objectAPIName = 'Account';
displayLabelField = 'Phone';
@api iconName = 'standard:Account';
@api labelForComponent = 'Search Account Using Phone No';
@api placeHolder = 'Enter Registered Mobile Number';
@api recordLimit = 10;
...
noRecordFound = false;
     ...
     // Creates the event with the data.
          const selectedEvent = new CustomEvent("progressvaluechanges", {
