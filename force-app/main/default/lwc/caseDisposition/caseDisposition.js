...
export default class DynamicPageGenerator extends LightningElement {
               ...
               .then(result => {
                    if (result) {
                         ...
                         for (var key in this.data1) {           
                            ...
                            //   if((this.data1)[key]=='CSE_Remarks__c'){
                            //     this.caseFieldSet.push({key: key, value:(this.data1)[key]})
                            //   }
                         }  
     ...
     callApexMethod4(){
        ...
        getCaseRecord({caseId: this.recordId})
                  ...
                  if (result) {
                    ...
                    this.selectedCaseCategory = result.Case_Category__c
   ...
   updateStatusfield(){
    ...
    handleShowSubFields(){
        ...
        //         // }
        //         if(this.caseField[i].value == 'CSE_Remarks__c'){
        //             this.sendCaseField.push(this.caseField[i]);
        //         }
        //     }
        //     this.showSubFields = true;
